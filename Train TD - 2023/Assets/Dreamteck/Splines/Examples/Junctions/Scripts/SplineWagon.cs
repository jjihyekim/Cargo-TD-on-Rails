namespace Dreamteck.Splines.Examples
{
    ...
    public class SplineWagon : MonoBehaviour
    {
        ...
        void SetupRecursively(SplineWagon frontSplineWagon, SplineSegment inputSegment)
        {
            front = frontSplineWagon;
        ...
        SplineWagon GetRootWagon()
        {
            SplineWagon current = this;
