namespace Dreamteck.Splines.Examples
{
    ...
    public class SplineTrainEngine : MonoBehaviour
    {
        private SplineTracer _tracer = null;
        private double _lastPercent = 0.0;
        private SplineWagon _splineWagon;

        private void Awake()
        {
            _splineWagon = GetComponent<SplineWagon>();
        }
        ...
        void SwitchSpline(Node.Connection from, Node.Connection to)
        {
            ...
            _splineWagon.EnterSplineSegment(from.pointIndex, _tracer.spline, to.pointIndex, _tracer.direction);
            _splineWagon.UpdateOffset();
        }
    }
}
