...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        public float waitAtTheEndSeconds = 20f;
        ...
        private Vector3 GetRoutePosition(float dist)
        {
            ...
            if (smoothRoute)
            {
                ...
                P0 = points[p0n].position;
                P1 = points[p1n].position;
                P2 = points[p2n].position;
                P3 = points[p3n].position;
            ...
            else
            {
                ...
                return Vector3.Lerp(points[p1n].position, points[p2n].position, i);
            }
        }
        ...
        private void CachePositionsAndDistances()
        {
            ...
            points = new Transform[Waypoints.Length];
